...
class CourseView(APIView):
    def get(self, request):
        ...
        all_results = list(chain(all_titles, all_professors, all_majors, all_majors_numbers, all_crns))
    ...
    def post(self, request):
        ...
        return Response({'message': 'File processed successfully!'}, status=HTTP_201_CREATED)
